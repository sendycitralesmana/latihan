            ...
            <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info btn-sm" href="/post/{{ $data->id }}/detail">Detail</a>
                                @if (Auth::user()->id_role == 1)
                                    <a class="btn btn-warning btn-sm" href="/post/{{ $data->id }}/edit">Edit</a>
                                    <a class="btn btn-danger btn-sm" href="/post/{{ $data->id }}/delete"
