        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="/user/show_delete" class="btn btn-info">Show Deleted Data</a>
            ...
            <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info btn-sm" href="/user/{{ $data->id }}/detail">Detail</a>
                                @if (Auth::user()->id_role == 1)
                                    <a class="btn btn-warning btn-sm" href="/user/{{ $data->id }}/edit">Edit</a>
                                    <a class="btn btn-danger btn-sm" href="/user/{{ $data->id }}/delete"
